...
#End Region
  ...
  Private mobjText As New StringBuilder()
    ...
    'Declares the Port and IP
    Public Property Port As Integer
    Public Property IP As String

    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Stores port from form2
        Port = Form2.Port
        'Declares the IP and Port
  ...
  End Sub
    ...
    ' makes sure to call display text from another thread
  Private Sub DisplayText(ByVal t As String)
        Dim params() As Object = {t}
        Me.Invoke(New DisplayInvoker(AddressOf Me.DisplayTextThread), params)
    End Sub

    Private Sub DisplayTextThread(ByVal t As String)
