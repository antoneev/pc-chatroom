...
#End Region
  ...
  End Sub
    ...
    'Passes in the port number
    Public Property StringPass As String

    Private Sub DoListen()
    Try
            'Dynamically allocates the port number
            mobjListener = New TcpListener(CInt(StringPass))
            'Outputs the port number
            UpdateStatus("Listener started on port " + StringPass)
